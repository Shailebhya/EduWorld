...
class _addScreenState extends State<addScreen> {
  Widget Education() {
    ...
    getItems() {
      ...
      usersRef
          .doc(currentUser.id)
          .update({"Education": FieldValue.arrayUnion(holder_1)});
    }
  ...
  Widget ModeOfTutoring() {
    ...
    getItems() {
      ...
      usersRef
          .doc(currentUser.id)
          .update({"ModeOfTutoring": FieldValue.arrayUnion(holder_1)});
    }
  ...
  Card buildkey(String t, [TextEditingController controller]) {
    return Card(
      ...
      child: ListTile(
        dense: true,
        title:
        Text("$t: ", style: TextStyle(color: Colors.black, fontSize: 20)),
